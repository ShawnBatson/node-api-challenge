...
A: Server side routing and middleware

-   [ x] Describe Middleware?

A: Middleware is an async function that has access to the request and response parameters and executes in the order that they are written in until a resolution is reached or the chain is cancelled with an error.

-   [ x] Describe a Resource?

A: something with which to use the CRUD operations on. It is basically anything that is on the server (endpoints)

-   [ x] What can the API return to help clients know if a request was successful?

A: a status code in the 200-299 range

-   [ x] How can we partition our application into sub-applications?

A: by separating endpoints into content-specific files? (all post endpoints in a post.js file, all user endpoints in a user.js file)
